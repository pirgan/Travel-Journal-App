  ...
  return (
    <AuthLayout>
      <div className="bg-white rounded-[20px] shadow-card w-full max-w-[440px] p-10 sm:p-11">
        <h1 className="font-display text-[32px] font-bold text-ink-dark leading-tight mb-1">Create account</h1>
        <p className="text-ink-secondary text-sm mb-6">Start your travel journal today</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label htmlFor="reg-name" className="block text-xs font-semibold text-ink-secondary mb-1.5">
              Full name
            </label>
            <input
              id="reg-name"
              ...
              className="w-full border border-border-mid rounded-xl px-4 py-3 text-sm text-ink-dark placeholder:text-ink-muted focus:outline-none focus:border-terracotta focus:ring-2 focus:ring-terracotta/15 bg-[#FAF6F1]"
            />
          </div>
          <div>
            <label htmlFor="reg-email" className="block text-xs font-semibold text-ink-secondary mb-1.5">
              Email address
            </label>
            <input
              id="reg-email"
          ...
          <div>
            <label htmlFor="reg-password" className="block text-xs font-semibold text-ink-secondary mb-1.5">
              Password
            </label>
